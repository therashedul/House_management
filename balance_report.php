		...
		<div class="card">
			<div class="card-body">
				<div class="col-md-12">
					...
					<div id="report">
						<div class="on-print">
							 <p><center>House Balances Report</center></p>
						...
						<div class="row">
							<table class="table table-bordered">
								...
								<tbody>
									...
									$i = 1;
									$tamount = 0;
									$tenants =$conn->query("SELECT  t.*, t.fullname, s.total_bill FROM tenants t  INNER JOIN slipes s on t.id = s.tenant_id where t.status = 1 order by s.id desc ");

										// $tenants =$conn->query("SELECT t.*,concat(t.fullname) as name,h.house_no,h.price FROM tenants t inner join houses h on h.id = t.house_id where t.status = 1 order by h.house_no desc ");
									...
									<tr>
										...
										<td class="text-right"><?php echo number_format($row['total_bill'],2) ?></td>

 ...
 * Document creator.
 */
define ('PDF_CREATOR', 'Md Rashedul Karim');

/**
 * Document author.
 */
define ('PDF_AUTHOR', 'Md Rashedul Karim');

/**
 * Header title.
 */
define ('PDF_HEADER_TITLE', 'Nadir Villa');

/**
 * Header description string.
 */
define ('PDF_HEADER_STRING', "by Md Rashedul Karim \nwww.webxpartbd.com");

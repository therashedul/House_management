		...
		<div class="col-md-12">
			<div class="card">
				<div class="card-header">
					<b>List of Slip</b>
					<span class="float:right"><a class="btn btn-primary btn-block btn-sm col-sm-2 float-right" href="javascript:void(0)" id="new_divided">
					...
					<table class="table table-condensed table-bordered table-hover" id="example">
						<thead>
							<tr>
								...
								<th class="">Total Taka</th>
								<th class="">Rupon</th>
								<th class="">Rony</th>
								<th class="">Rony Cost</th>
								...
								<tr>
									<td class="text-center"><?php echo $i++ ?></td>
									 <?php
                                                ...
                                                ?>
									<td>
										<?php  echo $payment->num_rows > 0 ? number_format($payment->fetch_array()['paid'], 2) : 0; ?>
									</td>
									<td>
...
<script>
	...
	$('#new_divided').click(function(){
		uni_modal("New Divided","manage_divided.php","mid-large")
	...
	$('.edit_slip').click(function(){
		uni_modal("Manage Slip Details","manage_divided.php?id="+$(this).attr('data-id'),"mid-large")
